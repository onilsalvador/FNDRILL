## Hey all Rodrigo here, this mod was made with Psych Engine

the rest of the readme file is just the same readme file as in the psych engine source code

continue reading if you want to know how to compile this thing
