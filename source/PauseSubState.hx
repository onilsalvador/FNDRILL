...
class PauseSubState extends MusicBeatSubstate
{
	...
	public static var gearmo:FlxSprite;
	...
	public function new(x:Float, y:Float)
	{
		...
		gearmo = new FlxSprite().loadGraphic(Paths.image('gearmo'));
		gearmo.setGraphicSize(Std.int(gearmo.width * 0.5));
		gearmo.updateHitbox();
		gearmo.screenCenter();
		gearmo.x = -700;
		gearmo.antialiasing = ClientPrefs.globalAntialiasing;
		FlxTween.tween(gearmo, {x: 0}, 0.8, {ease: FlxEase.sineInOut});
		add(gearmo);
