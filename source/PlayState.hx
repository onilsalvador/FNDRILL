...
class PlayState extends MusicBeatState
{
	...
	public var healthBarBag:FlxSprite;
	public var healthBarGear1:FlxSprite;
	public var healthBarGear2:FlxSprite;
	public var healthBarGear3:BGSprite;
	public var healthBarGearSKY:FlxSprite;
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'schoolEvil': //Week 6 - Thorns
				...
				case 'firstarea':
				var bg:BGSprite = new BGSprite('drill/area1', -500, -200, 0.9, 0.9);
				add(bg);
		}
		...
		healthBar2 = new FlxBar(0, FlxG.height * 0.89 - 17, RIGHT_TO_LEFT, Std.int(601 - 8), Std.int(18), this,
			'health', 0, 2);
		healthBar2.scrollFactor.set();
		healthBar2.screenCenter(X);
		// healthBar
		healthBar2.visible = !ClientPrefs.hideHud;
		if(ClientPrefs.downScroll) healthBar2.y = 0.11 * FlxG.height + 30;
		add(healthBar2);

		healthBar = new FlxBar(0, FlxG.height * 0.89 - 17, RIGHT_TO_LEFT, Std.int(601 - 228), Std.int(18), this,
			'health', 0, 2);
		healthBar.scrollFactor.set();
		healthBar.screenCenter(X);
		// healthBar
		healthBar.visible = !ClientPrefs.hideHud;
		if(ClientPrefs.downScroll) healthBar.y = 0.11 * FlxG.height + 30;
		add(healthBar);

		healthBarBG = new AttachedSprite('healthBar');
		healthBarBG.y = FlxG.height * 0.89 - 34 - 20; 
		...
		healthBarGear1 = new FlxSprite(940, FlxG.height * 0.89 - 34 - 20).loadGraphic(Paths.image('gear'));
		healthBarGear1.scrollFactor.set();
		healthBarGear1.visible = !ClientPrefs.hideHud;
		if(ClientPrefs.downScroll) healthBarGear1.y = 0.11 * FlxG.height;
		
		healthBarGear2 = new FlxSprite(940, FlxG.height * 0.89 - 34 - 20).loadGraphic(Paths.image('gear2'));
		healthBarGear2.scrollFactor.set();
		...
		healthBarGearSKY.visible = !ClientPrefs.hideHud;
		if(ClientPrefs.downScroll) healthBarGearSKY.y = 0.11 * FlxG.height;
		...
		healthBarBag = new FlxSprite(240, 0).loadGraphic(Paths.image('bag'));
		healthBarBag.y = FlxG.height * 0.89 - 34 - 20; 
		healthBarBag.scrollFactor.set();
		healthBarBag.visible = !ClientPrefs.hideHud;
		if(ClientPrefs.downScroll) healthBarBag.y = 0.11 * FlxG.height;
		add(healthBarBag);
		...
		scoreTxt = new FlxText(0, healthBarBG.y + 70, FlxG.width, "", 20);
		...
		healthBarGear1.cameras = [camHUD];
		healthBarGear2.cameras = [camHUD];
		healthBarGear3.cameras = [camHUD];
		healthBarGearSKY.cameras = [camHUD];
		healthBarBag.cameras = [camHUD];
	...
	public function reloadHealthBarColors() {
		...
		healthBar.updateBar();
		healthBar2.createFilledBar(FlxColor.fromRGB(dad.healthColorArray[0], dad.healthColorArray[1], dad.healthColorArray[2]),
			FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]));
